...
import { buildRuntimePathsPromptSummary } from "../paths/index.js";
...
export async function buildSystemPrompt(params: {
  ...
  const skillsPrompt = await buildSkillsPromptForCwd({ cwd: params.workspace });
  const runtimePathsPrompt = buildRuntimePathsPromptSummary();
